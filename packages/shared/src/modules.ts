...
export const MODULE_DEFINITIONS = [
  ...
  },
  {
    key: "vehicles",
    label: "Fuhrpark",
    description: "Vorführ-, Ersatz- und Poolfahrzeuge reservieren und Übergaben dokumentieren.",
    href: "/fuhrpark",
    icon: "Car",
    group: "ressourcen",
    core: false,
  ...
  },
  {
    ...
    description: "Aus DMS und Fahrzeugbörsen zusammengeführter Bestand für Verkauf und Beratung.",
  ...
  },
  {
    ...
    description: "Konnektoren zu Konzernsystemen, DMS, Fahrzeugbörsen, Bewertung und Buchhaltung.",
