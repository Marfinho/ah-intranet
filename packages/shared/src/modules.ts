...
export const MODULE_DEFINITIONS = [
  ...
  },
  {
    key: "shifts",
    label: "Schichtplan",
    description: "Besetzung je Standort und Abteilung, mit Diensttausch zwischen zwei Personen.",
    href: "/schichtplan",
    icon: "CalendarClock",
    group: "prozesse",
    core: false,
  ...
  {
    key: "custody",
    label: "Fundsachen & Schlüssel",
    description: "Wer hat welchen Schlüssel, wo liegt welcher Fund - mit Übergabe und Zeitstempel.",
    href: "/verwahrung",
    icon: "KeyRound",
    group: "prozesse",
    core: false,
  ...
  },
  {
    ...
    description: "Tagesangebot je Standort mit Stichtag und Sammelliste für die Abholung.",
    href: "/essen",
