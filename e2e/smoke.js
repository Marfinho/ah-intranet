...
const ROUTES = ["/", "/aktuelles", "/mitarbeiter", "/dokumente", "/wissen", "/kalender", "/raeume", "/fuhrpark",
  "/tickets", "/ideen", "/umfragen", "/abwesenheiten", "/onboarding", "/bestellungen/meine",
...
(async () => {
  ...
  for (const route of ROUTES) {
    ...
    const broken = r.status() >= 400 || txt.includes("Da ist etwas schiefgelaufen") || txt.includes("Seite nicht gefunden");
    if (broken) bad++;
